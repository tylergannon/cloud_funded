...
module CloudFunded
  class Application < Rails::Application
    ...
    config.assets.precompile += %w(jquery-ui-1.8.22.custom.min.js jquery-ui-1.8.22.custom.css mercury_manifest.js mercury_includes.js mercury_includes.css widget.css) 
